...
from .views import BookListAPIView, ListAPIView, BookListCreateView, BookRetrieveUpdateDestroyView, AddBookView, UpdateBookPriceView, RemoveBookView
...
urlpatterns = [
    ...
    path('all_books/', BookListAPIView.as_view(), name='book-list'),
]
